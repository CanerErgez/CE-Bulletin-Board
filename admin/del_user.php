...
/* Güncelleme İçin Kodlar */
	...
	$sql=mysqli_query($db,"DELETE FROM uyeler WHERE kullanici_adi='$kullanici_adi'");

	if($sql) {
		echo '<div class="container theme-showcase" role="main">
                    <div class="alert alert-success">
                        <strong>Tebrikler !</strong> Uye Başarıyla Silindi .
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
		  ...
		  <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="del_user.php">Kullanıcı Sil</a></li>
          </ul>
		  <ul class="nav nav-sidebar">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">Kullanıcı Sil</h1>

		  <form class="form-signin" role="form" action="del_user.php" method="GET">
		  Lütfen Silmek Istediğiniz Üye Kullanıcı Adını HATASIZ Giriniz .
