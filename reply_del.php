...
if(isset($_POST['guncel_reply_id'])) {
	...
	$sql = mysqli_query($db,"DELETE FROM cevaplar WHERE id='$cevap_for_id'");

		if($sql) {
		echo '<div class="container theme-showcase" role="main">
                    <div class="alert alert-success">
                        <strong>Tebrikler !</strong> Cevabınız Başarıyla Silindi .
...
<html lang="tr">
  <head>
    ...
    <meta name="description" content="Cevabı Sil Sayfası">
    <link rel="shortcut icon" href="assets/ico/favicon.ico">

    <title>Cevabı Sil</title>
...
?>
	...
	<div class="container">
		<form class="form-signin" role="form" action="reply_del.php" method="POST">
